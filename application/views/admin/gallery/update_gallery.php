                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    <tr>
                      ...
                      <td>
                        <input type="text" name="heading" class="form-control" placeholder="" required value="<?=$gallery_data->heading?>"/>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        ...
                        <img id="slide_img_path" height=50 width=100 src="<?php echo base_url().$gallery_data->image ?>">
                      </td>
                    </tr>
                    <tr>
                      <td colspan="2">
