      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Add New Important Acts&Rules</h3>
          </div>
          ...
          <div class="panel-body">
            <div class="col-lg-10">
              <form action="<?php echo base_url() ?>dcadmin/Important_Acts_Rules/add_important_acts_rules_data/<? echo base64_encode(1); ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td>
                          <input type="radio" id="pdf" name="type" value="1" checked onclick="change(1)">
                        <label for="pdf">PDF</label>
                          <input type="radio" id="link" name="type" value="2" onclick="change(2)">
                    ...
                    <tr id="change">
                      ...
                      <td>
                        <input type="file" name="pdf_link" class="form-control" placeholder="" required value="" />
                      </td>
                    </tr>
