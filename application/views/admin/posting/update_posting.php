      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Update Present Posting</h3>
          </div>
          ...
          <div class="panel-body">
            <div class="col-lg-10">
              <form action="<?php echo base_url() ?>dcadmin/Posting/add_posting_data/<? echo base64_encode(2); ?>/<?=$id?>" method="POST" id="slide_frm" enctype="multipart/form-data">
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td>
                        <input type="text" name="name" class="form-control" placeholder="" required value="<?=$posting->name?>" />
                      </td>
                    </tr>
                    <tr>
                      <td> <strong>Date From</strong> <span style="color:red;">*</span></strong> </td>
                      <td>
                        <input type="date" name="date_from" class="form-control" placeholder="" required value="<?=$posting->date_from?>" />
                      </td>
                    </tr>
                    <tr>
                      <td> <strong>Date To</strong> <span style="color:red;">*</span></strong> </td>
                      <td>
                        <input type="date" name="date_to" class="form-control" placeholder="" required value="<?=$posting->date_to?>" />
                      </td>
                    </tr>
